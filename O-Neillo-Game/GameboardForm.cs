...
namespace Oneillo_2
{
    public partial class GameboardForm : Form
    {
        ...
        public void FlipValidCounters(int row, int col, int player)  // flips counters
        {
            (int x, int y)[] OFFSETS =
            {
            ...
            {
                int changeInRow = offset.x;   // offset for x and y axis seperate
                int changeInCol = offset.y;
        ...
        public void LoadGame(GameState loadSavedGameState)     // function to fetch needed variables for resuming a game
        {
